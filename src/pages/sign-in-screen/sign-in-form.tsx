  ...
  return(
    <form onSubmit={onSubmit} className="sign-in__form" >
      ...
      <div className="sign-in__submit">
        <button className="sign-in__btn" type="submit" disabled={isLoginDataLoading}><AsyncComponent isLoading={isLoginDataLoading}><div>Sign in</div></AsyncComponent></button>
      </div>
    </form>
  );
}
